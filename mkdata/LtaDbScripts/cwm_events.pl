...
my $ddl_dmls = ();
my $create_chosen_table = "CREATE TABLE cwm.cwm_events(
	id bigint NOT NULL DEFAULT nextval('cwm.cwm_events_seq'::regclass),
	shift_id bigint,
	...
	user_edit bigint,
	task_type_id bigint,
	CONSTRAINT cwm_events_id PRIMARY KEY (id)
	
);";
push @$ddl_dmls, $create_chosen_table unless table_exists('cwm_events', 'cwm', $dbh);
