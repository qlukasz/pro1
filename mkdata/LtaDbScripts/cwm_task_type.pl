...
my $ddl_dmls = ();
my $create_chosen_table = "CREATE TABLE cwm.cwm_task_type(
	id bigint NOT NULL DEFAULT nextval('cwm.cwm_task_type_seq'::regclass),
	name character varying(100),
	short_name character varying(5),
	CONSTRAINT cwm_task_type_id PRIMARY KEY (id)
	
);";
push @$ddl_dmls, $create_chosen_table unless table_exists('cwm_task_type', 'cwm', $dbh);
