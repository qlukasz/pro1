...
my $ddl_dmls = ();
my $create_chosen_table = "CREATE TABLE cwm.cwm_skills (
	id bigint NOT NULL DEFAULT nextval('cwm.cwm_skills_seq'::regclass),
	name character varying(100),
	short_name character varying(5),
	CONSTRAINT cwm_skills_id PRIMARY KEY (id)
);";
push @$ddl_dmls, $create_chosen_table unless table_exists('cwm_skills', 'cwm', $dbh);
